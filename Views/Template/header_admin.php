...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <meta name="description" content="Reto Reaccion Digital | Caso Practico | Punto De Venta">
  ...
  <body class="app sidebar-mini">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="<?= base_url();?>dashboard">Punto De Venta</a>
